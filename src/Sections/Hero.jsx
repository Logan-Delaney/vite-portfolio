        ...
        <section className="min-h-screen w-full flex flex-col relative">
            ...
            <div className="absolute bottom-7 left-0 right-0 w-full z-10 c-space flex justify-center">
                <a href="#contact" className="w-fit">
                    {/* <Button name="Let's Build Something Together" isBeam containerClass="sm:w-fit w-full sm:min-w-96"/> */}
                    <button className="mt-6 px-6 py-3 rounded-full bg-white text-black font-semibold shadow-md hover:shadow-lg transition-transform hover:scale-105 opacity-50 hover:opacity-100">
